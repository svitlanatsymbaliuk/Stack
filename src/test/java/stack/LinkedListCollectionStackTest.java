...
public class LinkedListCollectionStackTest {
	@Test
	public void testPushStringObj() {
		String stringObj = "String Object";
		StackInterface<String> stack = new LinkedListCollectionStack<String>();
	...
	public void testPushIntNum() {
		Integer intNum = 0;
		StackInterface<Integer> stack = new LinkedListCollectionStack<Integer>();
		int n = 10000;
		for (int i = 1; i < n; ++i) {
			intNum = n;
			stack.push(intNum);
	...
	public void testPushObject() {
		...
		StackInterface<Object> stack = new LinkedListCollectionStack<Object>();
		stack.push(obj);
